...
import com.ishui.beans.DemoPulisher;
...
public class App {
	...
	public static void main(String[] args) {
		AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(EventConfigre.class);
		DemoPulisher demoPulisher = context.getBean(DemoPulisher.class);
		demoPulisher.pulisher("您好，这是应用事件 ");
		context.close();
